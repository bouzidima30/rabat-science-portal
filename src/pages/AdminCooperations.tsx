    ...
    <div className="p-4 sm:p-6 lg:p-8 bg-muted/30 min-h-screen">
        ...
        <CardContent className="p-6">
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <select
              ...
              className="h-12 px-3 rounded-md border-0 bg-muted/30 text-sm w-full lg:w-56"
            >
      ...
      <div className="space-y-6">
        {paginatedCooperations.map((cooperation) => (
          <Card key={cooperation.id} className="border-0 shadow-lg hover:shadow-xl transition-all duration-200 bg-card">
            <CardContent className="p-6">
