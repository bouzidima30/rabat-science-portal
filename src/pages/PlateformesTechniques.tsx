            ...
            <div className="text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <p className="text-muted-foreground">Plateformes Actives</p>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-primary mb-2">50+</h3>
                  <p className="text-muted-foreground">Équipements Majeurs</p>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-primary mb-2">200+</h3>
                  <p className="text-muted-foreground">Utilisateurs/An</p>
                </div>
              </div>
            </div>
          </CardContent>
