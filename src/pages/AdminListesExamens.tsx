...
const CATEGORIES = [
  { key: "listes_examens_automne", label: "Session d'Automne" },
  { key: "listes_examens_printemps", label: "Session de Printemps" },
];

const AdminListesExamens = () => {
  ...
  const deleteItemMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["admin-listes-examens"] });
    ...
    try {
      ...
      for (const [relativePath, zipEntry] of sorted) {
        ...
        if (zipEntry.dir) {
          ...
          const storagePath = `listes-examens/${storageName}`;
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-foreground dark:text-white">Listes des Examens</h1>
...
export default AdminListesExamens;
