...
import { Folder, File, Trash2, Archive, Loader2, Copy, Users } from "lucide-react";
    ...
    return (
      <div className="space-y-4">
        <div className="flex justify-end gap-2">
          ...
          <Button size="sm" asChild disabled={uploading} className="bg-teal-600 hover:bg-teal-700 shadow-lg">
    ...
    <div className="p-4 sm:p-6 lg:p-8">
      <div className="mb-8">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Sections et Groupes</h1>
            ...
            <Card key={cat.key} className={`border-0 shadow-lg bg-gradient-to-r ${theme.grad}`}>
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  ...
                  <Users className={`h-6 w-6 ${theme.color}`} />
                </div>
              </CardContent>
            </Card>
          );
