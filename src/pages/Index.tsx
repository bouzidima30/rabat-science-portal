      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Users, value: "15,000+", label: "Étudiants", color: "text-blue-600" },
              { icon: BookOpen, value: "50+", label: "Formations", color: "text-green-600" },
              { icon: Award, value: "200+", label: "Enseignants", color: "text-purple-600" },
              { icon: Building, value: "12", label: "Laboratoires", color: "text-orange-600" }
            ].map((stat, index) => (
