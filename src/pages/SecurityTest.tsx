...
import { SECURITY_TESTS, PERFORMANCE_METRICS, SECURITY_SCORE_THRESHOLDS, STATUS_COLORS, SEVERITY_COLORS } from "@/data/securityTestsData";
...
const SecurityTest = () => {
  ...
  const getAllSecurityTests = () => SECURITY_TESTS;
