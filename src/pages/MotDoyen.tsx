                ...
                <div className="flex items-start mb-6">
                  ...
                  <div>
                    ...
                    <blockquote className="border-l-4 border-primary pl-4 italic text-muted-foreground dark:text-muted-foreground my-6">
                      ...
                      <footer className="text-sm not-italic mt-2 text-muted-foreground">
              ...
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <div className="text-left space-y-3">
                    <div>
                      <h4 className="font-semibold text-foreground dark:text-white text-sm">Mandat :</h4>
                      <p className="text-muted-foreground dark:text-gray-300 text-sm">
                        Depuis 2025
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-foreground dark:text-white text-sm">Vision :</h4>
                      <p className="text-muted-foreground dark:text-gray-300 text-sm">
                        Projet de Développement de l'Établissement (PDE) 2025-2029
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-foreground dark:text-white text-sm">Email :</h4>
                      <p className="text-muted-foreground dark:text-gray-300 text-sm">
                        decanat@fsr.ac.ma
                      </p>
                    </div>
