                ...
                {item.hasDropdown ? (
                  <div>
                    ...
                    <div className={`overflow-hidden transition-all duration-300 ease-in-out ${
                      ...
                      <div className="bg-muted transform transition-transform duration-300 ease-in-out">
                        {item.dropdownItems?.map((dropdownItem, index) => (
                          <Link
                            key={dropdownItem.name}
                            to={dropdownItem.path}
                            onClick={() => handleMobileNavigation(dropdownItem.path)}
                            className={`block w-full text-left p-4 pl-8 text-muted-foreground hover:bg-accent hover:text-primary transition-all duration-200 border-t border-border first:border-t-0 transform ${
                              expandedMobileMenu === item.name 
                  ...
                  <Link
                    ...
                    className="block w-full text-left p-4 text-lg font-medium text-foreground hover:bg-accent hover:text-primary transition-colors"
                  >
                    {item.name}
                  </Link>
                )}
