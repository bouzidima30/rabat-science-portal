  ...
  const menuItems = [
    { name: "Accueil", path: "/", hasDropdown: false },
    {
      ...
      dropdownItems: [
        ...
        { name: "FSR en chiffres", path: "/presentation/chiffres" },
    ...
    },
    {
      ...
      hasDropdown: true,
      dropdownItems: [
        { name: "LMD : Mode d'emploi", path: "/formations/lmd" },
        { name: "Formation licence", path: "/formations/licence" },
        { name: "Formation master", path: "/formations/master" },
        { name: "Formation doctorat", path: "/formations/doctorat" },
    ...
    },
    {
      ...
      dropdownItems: [
        ...
        { name: "Valorisation de la recherche", path: "/recherche/valorisation" },
        { name: "Structures de recherche", path: "/recherche/structures" },
        { name: "Domaines de recherche", path: "/recherche/domaines" },
        { name: "Plateformes techniques", path: "/recherche/plateformes" },
      ],
    },
